...
Item {
    ...
    function buildKeybinds() {
        ...
        let binds = [
            ...
            { k1: "SUPER", k2: "D", action: "App Launcher (Drun)", cmd: "bash ~/.config/niri/scripts/rofi_show.sh drun" },
            { k1: "ALT", k2: "TAB", action: "Window Switcher", cmd: "bash ~/.config/niri/scripts/rofi_show.sh window" },
            { k1: "SUPER", k2: "C", action: "Clipboard History", cmd: "bash ~/.config/niri/scripts/rofi_clipboard.sh" },
            { k1: "SUPER", k2: "F", action: "Open Firefox", cmd: "firefox" },
            { k1: "SUPER", k2: "E", action: "Open Nautilus", cmd: "nautilus" },
            { k1: "SUPER", k2: "Q", action: "Close Active Window", cmd: "niri msg action close-window" },
            { k1: "SUPER", k2: "SPACE", action: "Toggle Floating", cmd: "niri msg action toggle-window-floating" },
            { k1: "SUPER", k2: "L", action: "Lock Screen", cmd: "bash ~/.config/niri/scripts/lock.sh" },
            { k1: "PRINT", k2: "", action: "Screenshot", cmd: "bash ~/.config/niri/scripts/screenshot.sh" },
            { k1: "SHIFT", k2: "PRINT", action: "Screenshot (Edit)", cmd: "bash ~/.config/niri/scripts/screenshot.sh --edit" },
            { k1: "ALT+SHIFT", k2: "", action: "Switch Keyboard Layout", cmd: "niri msg action switch-layout next" },
            { k1: "SUPER", k2: "W", action: "Toggle Wallpaper Picker", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle wallpaper" },
            { k1: "SUPER", k2: "Q", action: "Toggle Music Widget", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle music" },
            { k1: "SUPER", k2: "B", action: "Toggle Battery Widget", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle battery" },
            { k1: "SUPER", k2: "S", action: "Toggle Calendar Widget", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle calendar" },
            { k1: "SUPER", k2: "N", action: "Toggle Network Widget", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle network" },
            { k1: "SUPER", k2: "V", action: "Toggle Volume Widget", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle volume" },
            { k1: "SUPER", k2: "M", action: "Toggle Monitors Widget", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle monitors" },
            { k1: "SUPER+SHIFT", k2: "T", action: "Toggle FocusTime", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle focustime" },
            { k1: "SUPER+SHIFT", k2: "S", action: "Toggle Stewart AI", cmd: "bash ~/.config/niri/scripts/qs_manager.sh toggle stewart" },
            ...
            { k1: "SUPER", k2: "ARROWS", action: "Focus Column", cmd: "niri msg action focus-column-right" },
            { k1: "SUPER+SHIFT", k2: "ARROWS", action: "Move Column", cmd: "niri msg action move-column-right" },
            { k1: "SUPER+CTRL", k2: "ARROWS", action: "Resize Column", cmd: "niri msg action set-column-width +10%" }
        ];
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/scripts/qs_manager.sh", "close"]) }
    }
                                    ...
                                    Repeater {
                                        ...
                                        Rectangle {
                                            ...
                                            MouseArea {
                                                ...
                                                onClicked: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/niri/scripts/qs_manager.sh", wsNum.toString()])
                                            }
                                        }
                                    }
                                }
